...
For more details on the churro design, checkout out the documentation at the [churrodata.com website](https://github.com/churrodata/churro/churro-User-Guide).
